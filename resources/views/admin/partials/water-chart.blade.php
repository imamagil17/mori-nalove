<div class="bg-white/40 backdrop-blur-md border border-white/30 rounded-3xl p-4 sm:p-6 shadow-sm transition-all duration-300 hover:bg-white/60 hover:shadow-md flex flex-col h-full flex-grow relative group w-full min-h-[480px]">
    <script src="https://cdn.jsdelivr.net/npm/chartjs-plugin-annotation@2.0.1/dist/chartjs-plugin-annotation.min.js"></script>

    <div class="flex flex-col gap-4 mb-6 shrink-0 w-full">
        
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between w-full border-b border-slate-100 pb-3 gap-3">
    ...
    <div id="chartSkeleton" class="absolute inset-x-6 top-36 bottom-8 animate-pulse flex items-end justify-between gap-2 pb-8 z-0">
    ...
    <div class="w-full flex-grow relative opacity-0 transition-opacity duration-500 z-10 h-[320px] sm:h-[380px] xl:h-full" id="chartContainer">
