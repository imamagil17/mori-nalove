<div
    class="bg-white/40 backdrop-blur-md border border-white/30 rounded-3xl p-6 shadow-sm transition-all duration-300 hover:bg-white/60 hover:shadow-md relative overflow-hidden flex-grow flex flex-col justify-between">
    ...
    <ul class="space-y-3" id="safetyGuide">
        <li class="flex items-start gap-3 text-sm">
            <span
                class="mt-0.5 w-5 h-5 rounded-full bg-green-100 text-green-600 flex items-center justify-center shrink-0 text-xs font-bold">1</span>
        ...
        <li class="flex items-start gap-3 text-sm mb-4">
            <span
                class="mt-0.5 w-5 h-5 rounded-full bg-red-100 text-red-600 flex items-center justify-center shrink-0 text-xs font-bold">!</span>
            <span class="text-slate-600">Jika status <strong class="text-red-600">AWAS</strong>, segera evakuasi ke
                titik kumpul terdekat.</span>
        </li>
    </ul>
    ...
    <button onclick="toggleMapModal()"
        class="mt-5 w-full py-2.5 bg-white/60 hover:bg-blue-50 text-slate-700 hover:text-blue-600 font-bold text-sm rounded-xl transition-colors flex items-center justify-center gap-2 border border-slate-200 shadow-sm backdrop-blur-sm">
